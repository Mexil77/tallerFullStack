//Sin JSX;
// let Title = React.createElement("h1", {}, "Hola 42 sin JSX");
// let SubTitle = React.createElement("h2", {}, "Como estas?");

// let Encabezado = React.createElement(
// 	"div",
// 	{ style: { backgroundColor: "#30af99" } },
// 	[Title, SubTitle]
// );

// const Title = () => {
// 	return <h1>Hola mundo Con JSX</h1>;
// };
// const SubTitle = (props) => {
// 	return <h2>Como estas {props.name}?</h2>;
// };
...
// 	let x = 5;
// 	return (
// 		<div style={{ backgroundColor: "#30af99" }}>
// 			<Title />
// 			<SubTitle name="Emmanuel" />
// 			<SubTitle name="Adriana" />
// 		</div>
// 	);
// }
...
//let data = axios.get(https://jsonplaceholder.typicode.com/posts).data;
let data = [
	{
		userId: 1,
		id: 1,
